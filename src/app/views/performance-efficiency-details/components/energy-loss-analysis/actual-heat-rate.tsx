...
const ActualHeatRate = () => {
	const [sortConfig, setSortConfig] = useState<SortConfig>({ key: null, direction: null });

	const tableData: TableRow[] = [
		{ id: '1', parameter: 'Flue Gas Out', heatBalance: '24500', reference: '25000', losses: '500' },
		{ id: '2', parameter: 'NPHR-HHV', heatBalance: '45000', reference: '500', losses: '500' },
		{ id: '3', parameter: 'Net Power', heatBalance: '500', reference: '500', losses: '500' },
		{ id: '4', parameter: 'Gross Power', heatBalance: '500', reference: '500', losses: '500' },
		{ id: '5', parameter: 'Gross Eff (LHV)', heatBalance: '500', reference: '500', losses: '500' },
		{ id: '6', parameter: 'GPHR', heatBalance: '500', reference: '500', losses: '500' },
		{ id: '7', parameter: 'Fuel Flow', heatBalance: '500', reference: '500', losses: '500' },
		{ id: '8', parameter: 'Aux Power', heatBalance: '500', reference: '500', losses: '500' },
	];
	...
	return (
		<View style={styles.container}>
			...
			<View style={[styles.row, styles.header]}>
				...
				<TouchableOpacity style={styles.cell} onPress={() => handleSort('losses')}>
					<Typography
						style={styles.headerText}
					...
					>
						...
						{sortConfig.key === 'losses' && sortConfig.direction === 'ascending'
							? '▲'
							: sortConfig.key === 'losses' && sortConfig.direction === 'descending'
								? '▼'
								: ''}
					</Typography>
				</TouchableOpacity>
